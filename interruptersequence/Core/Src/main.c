...
uint8_t Apatterns[] = {0x0B, 0xF0, 0xAA, 0x05}; // Patterns for A_serial
uint8_t AcurrentPatternIndex = 0; // chooses which pattern is there

//Global variables for B_Serial
uint8_t Bpatterns[]= {0x01, 0xF0, 0xAA, 0x55}; // Patterns for B_serial
uint8_t BcurrentPatternIndex = 0; // chooses which pattern is there
